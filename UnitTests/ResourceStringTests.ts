...
class CListTest implements IListTest {
	constructor(public testCase0: string, public testCase1: string, public testCase2: string, public testCase3: string) {
...
function cResourceStringApplyTestCase() {
	...
	var cList: CListTest = list;
	var iList: IListTest = cList;
